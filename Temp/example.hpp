...
public:
    ...
    void show(rs2::frame frame) //Display all frames
    {
        show(frame, { 0, 0, (float)_width, (float)_height });
    }
    void show2(rs2::video_frame frame) //Display only color frame
    {
        show(frame, { 0, 0, (float)_width, (float)_height });
    }
    void show_depth(rs2::depth_frame frame) //Display only depth frame
    {
        show(frame, { 0, 0, (float)_width, (float)_height });
    }
